...
## Overview
This guide helps Unity AI Assistant create the visual layer for the Ledge board game. The core domain logic is complete in `Assets/_Project/Ledge/Runtime/`. Your task is to create the Unity presentation layer following Magi project conventions.

## Current Architecture

### Completed Domain Layer (DO NOT MODIFY)
- **Location**: `Assets/_Project/Ledge/Runtime/`
- **Assembly**: `Magi.LedgeBoardGame.Runtime`
- **Namespace**: `Magi.LedgeBoardGame.Runtime`
- **Dependencies**:
  - `Unity.Mathematics` - Math library
  - `Unity.Burst` - High-performance compiler
  - `Unity.InputSystem` - New input system
  - `Magi.UnityTools.Runtime` - Shared utility library
- **Key Classes**:
...
- **Location**: `Assets/_Project/Ledge/Runtime/` (alongside domain)
- **Assembly**: `Magi.LedgeBoardGame.Runtime` (same assembly)
...
```csharp
// Location: Assets/_Project/Ledge/Runtime/Board/BoardPresenter.cs
using UnityEngine;
...
```csharp
// Location: Assets/_Project/Ledge/Runtime/Board/SpaceView.cs
using UnityEngine;
using TMPro;
using Magi.LedgeBoardGame.Runtime.Models;
...
```csharp
// Location: Assets/_Project/Ledge/Runtime/Game/GameController.cs
using UnityEngine;
using System.Collections.Generic;
using Magi.LedgeBoardGame.Runtime.Models;
using Magi.LedgeBoardGame.Runtime.Rules;
using Magi.LedgeBoardGame.Runtime.Config;
using Magi.LedgeBoardGame.Runtime.Board;
using Magi.LedgeBoardGame.Runtime.Builder;

namespace Magi.LedgeBoardGame.Runtime.Game
{
...
### 7. Input Handling
```csharp
// Using New Input System (already referenced in Magi.LedgeBoardGame.Runtime.asmdef)
...
- **Follow Magi namespace conventions**: All code should be under `Magi.LedgeBoardGame.Runtime`
...
### IF YOU SEE ERRORS:
1. **"Magi.UnityTools.Runtime not found"**
