...
## Overview
This guide helps Unity AI Assistant create the visual layer for the Ledge board game. The core domain logic is complete in `Assets/_Project/Scripts/BoardGame/`. Your task is to create the Unity presentation layer following Magi project conventions.

## Current Architecture

### Completed Domain Layer (DO NOT MODIFY)
- **Location**: `Assets/_Project/Scripts/BoardGame/`
...
- **Location**: `Assets/_Project/Scripts/BoardGame/` (alongside domain)
...
```csharp
// Location: Assets/_Project/Scripts/BoardGame/Board/BoardPresenter.cs
using UnityEngine;
...
```csharp
// Location: Assets/_Project/Scripts/BoardGame/Board/SpaceView.cs
using UnityEngine;
using TMPro;
using Magi.LedgeBoardGame.Models;
...
```csharp
// Location: Assets/_Project/Scripts/BoardGame/Game/GameController.cs
using UnityEngine;
using System.Collections.Generic;
using Magi.LedgeBoardGame.Models;
